...
import { useGetDestinations, useGetImageSet1, useGetImageSet2, useGetSelectedArticles } from '../../hooks/travel-app-hooks';
...
export default function Dashboard() {
  ...
  const { travelAppDestinations } = useGetDestinations();
  const { travelAppImageSet1 } = useGetImageSet1();
  const { travelAppImageSet2 } = useGetImageSet2();
          ...
          <div className={classes("column-layout bottom-content")}>
            <div className={classes("column-layout latest-articles")}>
              <div className={classes("row-layout group_1")}>
                ...
                <IgrButton variant="outlined" type="button" clicked={() => navigate(`/in-app/articles`)} className={classes("button")}>
                  ...
                  <IgrCard className={classes("card")} key={uuid()}>
                    ...
                    <IgrCardActions className={classes("actions-content")} key={uuid()}>
                      ...
                      <div slot="end" key={uuid()}>
                        <IgrButton variant="outlined" type="button" className={classes("button_1")} key={uuid()}>
            ...
            <div className={classes("column-layout destinations")}>
              ...
              <div className={classes("row-layout group_2")}>
                {travelAppDestinations?.map((item) => (
                  <IgrCard className={classes("card")} key={uuid()}>
                    <IgrCardMedia className={classes("media-content")} key={uuid()}>
                      <img src={item.image_url} className={classes("image")} key={uuid()} />
                    </IgrCardMedia>
