        ...
        <div className={classes("row-layout left")}>
          <div className={classes("column-layout group")}>
            ...
            <div className={classes("column-layout group_4")}>
              <IgrButton type="button" clicked={() => navigate(`/in-app/dashboard`)} className={classes("button")}>
                <span key={uuid()}>LOGIN</span>
                <IgrRipple key={uuid()}></IgrRipple>
              </IgrButton>
              <div className={classes("row-layout group_5")}></div>
              <IgrButton variant="outlined" type="button" clicked={() => navigate(`/home/sign-up`)} className={classes("button button_1")}>
